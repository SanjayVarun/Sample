...
public class ServiceProviderDAO {
	...
	public List<ServiceProviderBean> search(String location,String servetype)
	{    List<ServiceProviderBean> searchlist=null;
		String searchQuery="SELECT * FROM T_XBBNHFN_PROVIDERDETAILS WHERE SP_LOCATION=? AND SERVICE_TYPE=?";
		...
		while(rs.next())
		{
		    ...
		    sp.setService_provider_id(rs.getInt(1));
			sp.setService_provider_name(rs.getString(2));
			//System.out.println();
			sp.setService_provider_phone_number(rs.getString(3));
			sp.setService_provider_location(rs.getString(4));
			sp.setService_provider_from_time(rs.getString(5));
			sp.setService_provider_to_time(rs.getString(6));
			searchlist.add(sp);
